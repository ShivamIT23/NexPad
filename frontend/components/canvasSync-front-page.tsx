...
export function CanvasSyncFrontPage() {
      ...
      <header className="bg-white shadow-sm">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-gray-900">CanvasSync</span>
          </div>
          <div className="flex items-center space-x-4">
            <Link href="#" className="text-gray-500 hover:text-gray-900">Docs</Link>
            <Link href="#" className="text-gray-500 hover:text-gray-900">Blog</Link>
            <Link href="https://github.com/ShivamIT23/NexPad" className="text-gray-500 hover:text-gray-900">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Create, share, and collaborate on drawings in real-time. No sign-up required.
            </p>
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-2">
            ...
            <Link href="https://github.com/ShivamIT23/NexPad" className="text-gray-400 hover:text-gray-500">
              <span className="sr-only">GitHub</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; 2023 CanvasSync, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
